  ...
  try {
    ...
    for (let r = 1; r < rows.length; r++) {
      ...
      button.addEventListener('click', async () => {
        ...
        // Promena: Dodaj zarez (ili drugi separator) pre novog unosa ako polje već ima vrednost
        if (input4El.value) {
            input4El.value += ', '; // Možete promeniti ', ' u '\n' za novi red ili bilo koji drugi separator
        }
